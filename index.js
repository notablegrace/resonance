...
var electrode;
(function (electrode) {
    electrode[electrode["CP3"] = 0] = "CP3";
    electrode[electrode["C3"] = 1] = "C3";
    electrode[electrode["F5"] = 2] = "F5";
    electrode[electrode["PO3"] = 3] = "PO3";
    electrode[electrode["PO4"] = 4] = "PO4";
    electrode[electrode["F6"] = 5] = "F6";
    electrode[electrode["C4"] = 6] = "C4";
    electrode[electrode["CP4"] = 7] = "CP4";
})(electrode || (electrode = {}));
var freqs = [
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                smrThreshold = 0;
                thetaThreshold = 10;
                notion.brainwaves("psd").subscribe(function (brainwaves) {
                    var smrAmplitude = get_amplitude(brainwaves.psd, [electrode.C3, electrode.C4], [12, 14]);
                    ...
                    if (smrAmplitudes.length == 4) {
                        var smrAverage = average(smrAmplitudes);
                        var thetaAverage = average(thetaAmplitudes);
...
function get_amplitude(psd, electrodes, target_freqs) {
    var frequency_indexes = [];
    target_freqs.forEach(function (x) {
        frequency_indexes.push(freqs.indexOf(x));
    });
    var collected_amplitudes = [];
    electrodes.forEach(function (electrode) {
        var electrode_amplitudes = target_freqs.reduce(function (acc, freq) {
            return psd[electrode][freq] + acc;
        });
        var electrode_amplitudes_avg = electrode_amplitudes / target_freqs.length;
        collected_amplitudes.push(electrode_amplitudes_avg);
    });
    return (collected_amplitudes.reduce(function (a, b) { return a + b; }) / collected_amplitudes.length);
}
